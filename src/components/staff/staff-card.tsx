...
//     try {
//       const newStatus = staff.status === "on_shift" ? "off_shift" : "on_shift"

//       // Optimistically update the UI
//       setEditedStaff((prev) => ({ ...prev, status: newStatus }))

//       console.log(`Attempting to change status for staff ID: ${staff.id} to ${newStatus}`)
...
//           <Switch
//             checked={editedStaff.status === "on_shift"}
//             onCheckedChange={() => handleStatusChange(new MouseEvent("click") as any)}
//           />
//           <span
//             className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                setEditedStaff({ ...editedStaff, performance: Number.parseInt(e.target.value, 10) })
                              }
                            />
                          </div>
                        </div>
