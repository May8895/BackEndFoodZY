...
//   const { inventory, getLowStockItems, refetchInventory } = useInventory()
...
//       <AddProductDialog open={showAddProduct} onOpenChange={setShowAddProduct} onProductAdded={handleProductAdded} />
//       <ShareDialog open={showShare} onOpenChange={setShowShare} />
//       <TopUsedDialog open={showTopUsed} onOpenChange={setShowTopUsed} />
//       <LowStockDialog open={showLowStock} onOpenChange={setShowLowStock} />
//     </motion.div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ProductTable searchQuery={searchQuery} inventory={inventory} onInventoryUpdated={handleInventoryUpdate} />
      </motion.div>

      <AddProductDialog open={showAddProduct} onOpenChange={setShowAddProduct} onProductAdded={handleInventoryUpdate} />
      <ShareDialog open={showShare} onOpenChange={setShowShare} />
      <TopUsedDialog open={showTopUsed} onOpenChange={setShowTopUsed} />
      <LowStockDialog open={showLowStock} onOpenChange={setShowLowStock} />
    </motion.div>
