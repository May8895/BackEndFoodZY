...
import { ChevronDown, ChevronUp, SlidersHorizontal ,MoreHorizontal,Pencil,  Trash} from "lucide-react"
...
export function ProductTable({ searchQuery, inventory, onInventoryUpdated }: ProductTableProps) {
  const [selectedProducts, setSelectedProducts] = useState<string[]>([])
  const [sortColumn, setSortColumn] = useState<keyof InventoryItem>("name")
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("asc")
    ...
    <div>
              ...
              <TableCell>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => setDeletingProduct(item)} className="text-red-600">
      ...
      {editingProduct && (
        <EditProductDialog
          ...
          onProductUpdated={onInventoryUpdated}
        />
      )}
      ...
      {deletingProduct && (
        <DeleteProductDialog
          ...
          onProductDeleted={onInventoryUpdated}
        />
      )}
    </div>
  )
